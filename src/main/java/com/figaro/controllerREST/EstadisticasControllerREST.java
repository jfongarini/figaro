...
public class EstadisticasControllerREST {
    ...
    public ResponseEntity<Map<String, Integer>> buscarProductoMasVendido() throws ParseException {		
        return new ResponseEntity<Map<String, Integer>>(service.buscarProductoMasVendido(), HttpStatus.OK);
    }
